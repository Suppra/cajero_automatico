...
class FirebaseService {
  ...
  static Future<Map<String, dynamic>> obtenerEstadisticas() async {
    try {
      final docSnapshot = await _firestore
          .collection(_estadisticasCollection)
          .doc('general')
          .get();
  ...
  static Future<void> _actualizarEstadisticas(Transaccion transaccion) async {
    try {
      final estadisticasRef = _firestore
          .collection(_estadisticasCollection)
          .doc('general');
      ...
      await _firestore.runTransaction((transaction) async {
        ...
        if (transaccion.exitosa) {
          ...
          estadisticas['montoTotalRetirado'] = (estadisticas['montoTotalRetirado'] ?? 0.0) + transaccion.monto;
        }
